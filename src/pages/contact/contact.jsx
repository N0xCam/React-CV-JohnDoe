...
function Contact () {
    return (
        ...
        <div className="contact">
            ...
            <h2 className="tit-contact"> Me contacter </h2>
            <p className="little-title-contact"> Pour me contacter en vue d'un entretien ou d'une future collaboration, merci de remplir le formulaire de contact.</p>
            ...
            <h3 className="title-form"> Formulaire de contact</h3>
            ...
            <address className="contact-address">
                <em className="text-address"> <svg xmlns="http://www.w3.org/2000/svg" wclassNameth="16" height="16" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
                <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6"/>
                </svg> 40 Rue Laure Diebold, 69009 </em>
                <em className="text-address"> Lyon, France</em>
                <em className="text-address"> <svg xmlns="http://www.w3.org/2000/svg" wclassNameth="16" height="16" fill="currentColor" class="bi bi-phone" viewBox="0 0 16 16">
